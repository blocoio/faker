...
public class TimeTest {
  ...
  @Test public void between() throws Exception {
    ...
    DateTime between = faker.time.between(from, to);
  ...
  @Test public void dayPeriod() throws Exception {
    DateTime dayPeriod = faker.time.forward(1, Period.day);
  ...
  @Test public void nightPeriod() throws Exception {
    DateTime nightPeriod = faker.time.forward(1, Period.night);
  ...
  @Test public void morningPeriod() throws Exception {
    DateTime morningPeriod = faker.time.forward(1, Period.morning);
  ...
  @Test public void afternoonPeriod() throws Exception {
    DateTime afternoonPeriod = faker.time.forward(1, Period.afternoon);
  ...
  @Test public void eveningPeriod() throws Exception {
    DateTime eveningPeriod = faker.time.forward(1, Period.evening);
  ...
  @Test public void midnightPeriod() throws Exception {
    DateTime midnightPeriod = faker.time.forward(1, Period.midnight);
    assertThat(midnightPeriod.getHourOfDay(), is(both(greaterThanOrEqualTo(0)).and(lessThan(4))));
  }
}
